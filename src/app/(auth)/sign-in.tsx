...
/**
 * Welcome / auth — "Nebula": a cosmic, glowing backdrop with a frosted-glass
 * panel floating over it. Vibrant, alive, a little magic.
 */
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top', 'bottom']}>
        ...
        >
          ...
          <Animated.View entering={FadeIn.duration(650)} style={{ marginTop: theme.spacing.huge }}>
            ...
            <Text style={{ fontFamily: 'Fraunces_600SemiBold', fontSize: 46, lineHeight: 50, letterSpacing: -0.8, color: theme.colors.text, marginTop: theme.spacing.xl }}>
              Polaris
            </Text>
            <Text variant="body" color="textSecondary" style={{ marginTop: theme.spacing.md, maxWidth: 330, fontSize: 17, lineHeight: 26 }}>
